...
const actionTexts = ['le ha agarrado las tetas a', 'le ha sobado las ubres a', 'le ha apretado los senos a']

const endpoints = ['https://nekobot.xyz/api/image?type=boobs']
